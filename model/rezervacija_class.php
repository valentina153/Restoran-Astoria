...
class Rezervacija
{
    ...
    public static function dajRezervaciju($IDKorisnika){
        ...
        $upit = "SELECT * FROM rezervacija WHERE IDKorisnika = '" . $IDKorisnika . "' ORDER BY datum desc, IDtermina asc";
        $rezultat = mysqli_query($konekcija, $upit);
        $lista = array();
        while ($redak = mysqli_fetch_assoc($rezultat))
            array_push($lista, $redak);
    ...
    public static function dajSve(){
        ...
        $upit = "SELECT * FROM rezervacija WHERE datum >= '" . $datum . "' ORDER BY datum asc, IDtermina asc";
        $rezultat = mysqli_query($konekcija, $upit);
        $lista = array();
        while ($redak = mysqli_fetch_assoc($rezultat))
            array_push($lista, $redak);
